...
//						},3000);						
     		...
     		'afterSlideLoad': function(anchorLink, index, slideIndex, direction){
					$("#menu a").eq(direction).addClass("select2").siblings("a").removeClass("select2")
...
//							},3000);
		...
		*/
		...
		$.fn.fullpage.moveSlideRight = function(){
				var index=$('body').find('.fp-slide.active').index()
				...
				setTimeout(function(){
					removeMouseWheelHandler()
					removeTouchHandler();
					var index2=$('body').find('.fp-slide.active').index()
					
					//var indexclass2=$(".fp-slide").eq(indexT).find(".text4").attr("class")
					//alert(indexT)
					if(indexclass=="text4 texto"){
						$(".fp-slide").find(".text4").removeClass("texto")
						$(".fp-slide").find(".text4").css({"display":"none","top":"173px","opacity":"0",'filter':'alpha(opacity=0)'})	
						moveSlide('next');
						addMouseWheelHandler()
						addTouchHandler();
												
					}else{
					$('.fp-slide').stop().eq(index2).find(".text4").show()
					$('.fp-slide').stop().eq(index2).find(".text4").addClass("texto").animate({
						top: '173px',
						opacity:"1",
						...
						//$('.fp-slide').stop().eq(index).find(".text4").addClass("texto")
					}); 
					}						
				},1000)						
				}
				...
				function time()
				{
					removeMouseWheelHandler()
					removeTouchHandler();
				  // var i=$(".active .videoItem img.show").index();
				   var runs = $("section").eq(indexT).find(".videoItem img").length-1; 
				   ...
				   var loopit = function(){
						 if(i==runs){
						   ...
						   //console.info('我'+i)
							...
							$("section").eq(indexT).find(".videoItem img").eq(i+1).addClass("show").siblings().removeClass("show")
							i++;
				...
				if(index==1){
					...
					if($("section").eq(1).find(".videoItem img.show").index()==$("section").eq(1).find(".videoItem img").length-1){
						...
						time(i=$(".active").eq(1).find(".videoItem img.show").index(),indexT=1)	
				}
				if(index==2){
					removeMouseWheelHandler()
					removeTouchHandler();
					if($("section").eq(2).find(".videoItem img.show").index()==$("section").eq(2).find(".videoItem img").length-1){
						...
						time(i=$(".active").eq(2).find(".videoItem img.show").index(),indexT=2)	
				}				
				if(index==3){
					removeMouseWheelHandler()
					removeTouchHandler();
					if($("section").eq(3).find(".videoItem img.show").index()==$("section").eq(3).find(".videoItem img").length-1){
						...
						time(i=$(".active").eq(3).find(".videoItem img.show").index(),indexT=3)	
				}	
				if(index==4){
					removeMouseWheelHandler()
					removeTouchHandler();
					if($("section").eq(4).find(".videoItem img.show").index()==$("section").eq(4).find(".videoItem img").length-1){
						...
						time(i=$(".active").eq(4).find(".videoItem img.show").index(),indexT=4)	
				}					
				if(index==5){
					removeMouseWheelHandler()
					removeTouchHandler();
					if($("section").eq(5).find(".videoItem img.show").index()==$("section").eq(5).find(".videoItem img").length-1){
						...
						time(i=$(".active").eq(5).find(".videoItem img.show").index(),indexT=5)	
				}					
				if(index==6){
					removeMouseWheelHandler()
					removeTouchHandler();
					if($("section").eq(6).find(".videoItem img.show").index()==$("section").eq(6).find(".videoItem img").length-1){
						...
						time(i=$(".active").eq(6).find(".videoItem img.show").index(),indexT=6)	
				}									
...
//					addTouchHandler();
		...
		$.fn.fullpage.moveSlideLeft = function(){
				...
				function text2(){
					if(indexclass=="text4 texto"){
					$('.fp-slide').eq(index).find(".text4").removeClass("texto")
					$('.fp-slide').eq(index).find(".text4").animate({
						top: '173px',
						opacity:"0",
				...
				{
				  // var i=$(".active .videoItem img.show").index();
				   var runs = $(".active .videoItem img").length-1; 
				   var interval = 120; //循环周期
				   var loopit = function(){
						 if(i==0){
							addMouseWheelHandler()	
							...
							// alert(i)
							$(".active .videoItem img").eq(i-1).addClass("show").siblings().removeClass("show")
							i--;
							setTimeout(loopit,interval);
						 }
					}
...
//					}		
			...
			//	}
				...
				if(index==1){
					removeMouseWheelHandler()
					removeTouchHandler();
					if($("section").eq(1).find(".videoItem img.show").index()==0){
						//$(".active .videoItem img").eq(0).addClass("show").siblings().removeClass("show")
						moveSlide('prev');

					}
					text2()	
					time2(i=$(".active").eq(1).find(".videoItem img.show").index(),indexT=1)	
				...
				if(index==2){
					removeMouseWheelHandler()
					removeTouchHandler();
					if($("section").eq(2).find(".videoItem img.show").index()==0){
						moveSlide('prev');

					}
					text2()	
					time2(i=$(".active").eq(2).find(".videoItem img.show").index(),indexT=2)	
				}
				...
				if(index==3){
					removeMouseWheelHandler()
					removeTouchHandler();
					if($("section").eq(3).find(".videoItem img.show").index()==0){
						moveSlide('prev');

					}
					text2()	
					time2(i=$(".active").eq(3).find(".videoItem img.show").index(),indexT=3)	
				}				
				...
				if(index==4){
					removeMouseWheelHandler()
					removeTouchHandler();
					if($("section").eq(4).find(".videoItem img.show").index()==0){
						moveSlide('prev');

					}
					text2()	
					time2(i=$(".active").eq(4).find(".videoItem img.show").index(),indexT=4)	
				}				
				
				if(index==5){
					removeMouseWheelHandler()
					removeTouchHandler();
					if($("section").eq(5).find(".videoItem img.show").index()==0){
						moveSlide('prev');

					}
					text2()	
					time2(i=$(".active").eq(5).find(".videoItem img.show").index(),indexT=5)	
				}				
				if(index==6){
					removeMouseWheelHandler()
					removeTouchHandler();
					if($("section").eq(6).find(".videoItem img.show").index()==0){
						moveSlide('prev');

					}
					text2()	
					time2(i=$(".active").eq(6).find(".videoItem img.show").index(),indexT=6)	
				}				
