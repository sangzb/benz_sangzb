...
//							},3000);
		...
		*/
		...
		$.fn.fullpage.moveSlideRight = function(){
				...
				$("#testDrive .video_list").css({"left":"80%"})
				...
				function time()
				{
				    ...
				    var loopit = function(url){
						 if(indexS==indexL){
							...
							$("#slide1 .videoItem img").eq(indexS+1).addClass("show").siblings().removeClass("show")
						 	$("#slide1 .videoItem img").eq(indexS+3).addClass("show")
							indexS++;
						    stopC(indexTh)
